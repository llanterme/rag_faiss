...
def format_context_with_sources(chunks: List[Dict], include_metadata: bool = True) -> str:
...
def create_enhanced_prompt(
    ...
    elif '?' not in question and any(word in question_lower for word in ['tell me', 'show me']):
...
def add_few_shot_examples(prompt: str, task_type: str = "factual_qa") -> str:
    ...
    if task_type in FEW_SHOT_EXAMPLES:
        ...
        prompt = prompt.replace("Provided Context:", example_text + "\nProvided Context:")
